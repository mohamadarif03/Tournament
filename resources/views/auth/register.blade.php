    ...
    <body class>
        <div class="lg:flex lg:flex-row-reverse">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="mt-4 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2
                    ...
                    <div class="mt-6">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div>
                                ...
                                <input name="name" value="{{ old('name') }}" placeholder="Enter Your Username"
                                    required
            ...
            <div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
                <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
                    <svg class="w-5/6 mx-auto" xmlns="http://www.w3.org/2000/svg"
                        id="f080dbb7-9b2b-439b-a118-60b91c514f72" data-name="Layer 1" viewBox="0 0 528.71721 699.76785">
                        <title>Login</title>
