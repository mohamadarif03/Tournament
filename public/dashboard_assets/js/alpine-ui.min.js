(() => {
        ...
        e.bind(i, {
            ...
            "x-data"() {
                return {
                    ...
                    __contains(t, s) {
                        return !!e.findClosest(s, (a) => a.isSameNode(t));
                    },
                };
            },
            "@focusin.window"() {
    ...
    function D(i, e) {
        e.bind(i, {
            ...
            "@keydown.up.stop.prevent"() {
                this.$data.__open(_.Alpine, last);
            },
    ...
    function S(i, e) {
        e.bind(i, {
            ...
            "@keydown"(t) {
                _.search(e, this.$refs.__items, t.key, (s) => s.__activate());
            },
            "@keydown.down.stop.prevent"() {
                this.$data.__activeEl
                    ? _.next(e, this.$data.__activeEl, (t) => t.__activate())
                    : _.first(e, this.$refs.__items, (t) => t.__activate());
            },
            "@keydown.up.stop.prevent"() {
                this.$data.__activeEl
                    ? _.previous(e, this.$data.__activeEl, (t) =>
                          t.__activate()
                      )
                    : _.last(e, this.$refs.__items, (t) => t.__activate());
            },
                ...
                return {
                    ...
                    init() {
                        ...
                        for (let a = 0; a < t.length; a++)
                            if (
                                t[a].compareDocumentPosition(this.$el) &
                                Node.DOCUMENT_POSITION_PRECEDING
                            ) {
                                t.splice(a, 0, this.$el), (s = !0);
                                break;
                            }
                        s || t.push(this.$el),
                            (this.$el.__activate = () => {
    ...
    var _ = {
        first(i, e, t = (a) => a, s = () => {}) {
            let a = i.$data(e).__itemEls[0];
            return a
                ? a.tagName.toLowerCase() === "template"
                    ? this.next(i, a, t)
                    : a.__isDisabled.value
                    ? this.next(i, a, t)
                    : t(a)
                : s();
        },
        last(i, e, t = (a) => a, s = () => {}) {
            let a = i.$data(e).__itemEls.slice(-1)[0];
            return a
                ? a.__isDisabled.value
                    ? this.previous(i, a, t)
                    : t(a)
        ...
        previous(i, e, t = (a) => a, s = () => {}) {
            if (!e) return s();
            let a = i.$data(e).__itemEls,
                n = a[a.indexOf(e) - 1];
            return n
                ? n.__isDisabled.value || n.tagName.toLowerCase() === "template"
                    ? this.previous(i, n, t, s)
                    : t(n)
                : s();
        },
        searchQuery: "",
        ...
        search(i, e, t, s) {
            ...
            n && !n.__isDisabled.value && s(n), this.clearSearch(i);
        },
    };
    function c(i) {
    ...
    function I(i, e) {
        e.bind(i, {
            ...
            "x-effect"() {
                ...
                let s = this.$el.nextElementSibling;
                if (
                    (s && String(s.id) === String(this.__inputId) && s.remove(),
                    t)
                ) {
                    let a = document.createElement("input");
                    (a.type = "hidden"),
                        (a.value = this.__inputValue),
                        (a.name = this.__inputName),
                        (a.id = this.__inputId),
                        this.$el.after(a);
                }
            },
        ...
        e.bind(i, {
            ...
            "@keydown.tab"(t) {
                if (!t.shiftKey && this.$data.__isOpen) {
                    let s = this.$focus.within(this.$data.__panelEl).getFirst();
                    s &&
                        (t.preventDefault(),
                        t.stopPropagation(),
                        this.$focus.focus(s));
            ...
            "@keyup.tab"(t) {
                if (this.$data.__isOpen) {
                    let s = this.$focus.previouslyFocused();
                    if (!s) return;
                    !this.$data.__buttonEl.contains(s) &&
                        !this.$data.__panelEl.contains(s) &&
                        s &&
                        this.$el.compareDocumentPosition(s) &
        ...
        e.bind(i, {
            ...
            "@keydown.tab"(t) {
                if (t.shiftKey && this.$focus.isFirst(t.target))
                    ...
                    let s = this.$focus.within(document).all(),
                        a = s.indexOf(this.$data.__buttonEl);
                    s
                        .splice(a + 1)
                        .filter((o) => !this.$el.contains(o))[0]
                        .focus(),
                ...
                return {
                    ...
                    __addOption(t, s, a) {
                        let n = e.raw(this.__optionValues),
                            o = n.map((d) => this.__optionElsByValue.get(d)),
                            r = !1;
                        for (let d = 0; d < o.length; d++)
                            if (
                                o[d].compareDocumentPosition(s) &
                                Node.DOCUMENT_POSITION_PRECEDING
                            ) {
                                n.splice(d, 0, t),
                                    this.__optionElsByValue.set(t, s),
                                    (r = !0);
                                break;
                            }
                        r || (n.push(t), this.__optionElsByValue.set(t, s)),
                            a && this.__disabledOptions.add(t);
                    },
                    __isFirstOption(t) {
                    ...
                    __focusOptionNext() {
                        let t = this.__active,
                            s = this.__optionValues.filter(
                                (n) => !this.__disabledOptions.has(n)
                            ),
                            a = s[this.__optionValues.indexOf(t) + 1];
                        (a = a || s[0]),
                            this.__optionElsByValue.get(a).focus(),
                            this.__change(a);
                    },
                    __focusOptionPrev() {
                        let t = this.__active,
                    ...
                    init() {
                        queueMicrotask(() => {
                            let t =
                                ...
                                s = this.__activeTabs(),
                                a = (n, o, r) => Math.min(Math.max(n, o), r);
                            (this.__selectedIndex = a(t, 0, s.length - 1)),
                                e.effect(() => {
